  ...
  <main class="hoc container clear"> 
    ...
    <section id="services">
      ...
      <c:forEach var="dto" items="guideList">
        <li class="one_third">
          <article><a href="<c:url value='host/guide/guide_context'/>?contentId=${dto.contentId}"><i class="fas fa-spray-can"></i></a>
            <h6 class="heading">${dto.subject}</h6>
            <p>${dto.explanation}</p>
            <footer><a href="<c:url value='host/guide/guide_context'/>?contentId=${dto.contentId}">더보기 &raquo;</a></footer>
          </article>
        </li>
        </c:forEach>
      </ul>
